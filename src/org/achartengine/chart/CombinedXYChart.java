...
//	    mCharts = new XYChart[length];
//	    mCharts[0] = new BarChart(dataset, renderer, Type.DEFAULT);
//	    XYMultipleSeriesDataset newDataset = new XYMultipleSeriesDataset();
//        newDataset.addSeries(dataset.getSeriesAt(0));
//        newDataset.addSeries(dataset.getSeriesAt(1));
//        
//        XYMultipleSeriesRenderer newRenderer = new XYMultipleSeriesRenderer();
//        newRenderer.setBarSpacing(renderer.getBarSpacing());
//        newRenderer.setPointSize(renderer.getPointSize());
//        int scale = dataset.getSeriesAt(0).getScaleNumber();
//        if (renderer.isMinXSet(scale)) {
//          newRenderer.setXAxisMin(renderer.getXAxisMin(scale));
//        }
//        if (renderer.isMaxXSet(scale)) {
...
//          newRenderer.setYAxisMax(renderer.getYAxisMax(scale));
//        }
//        newRenderer.addSeriesRenderer(renderer.getSeriesRendererAt(0));
//        scale = dataset.getSeriesAt(1).getScaleNumber();
//        if (renderer.isMinXSet(scale)) {
//          newRenderer.setXAxisMin(renderer.getXAxisMin(scale));
//        }
//        if (renderer.isMaxXSet(scale)) {
...
//          newRenderer.setYAxisMax(renderer.getYAxisMax(scale));
//        }
//        newRenderer.addSeriesRenderer(renderer.getSeriesRendererAt(1));
//        mCharts[0].setDatasetRenderer(newDataset, newRenderer);
//	    
//	    
//	    
//	    
//	      try {
//	        mCharts[1] = getXYChart(types[2]);
//	      } catch (Exception e) {
//	        // ignore
//	      }
//	      if (mCharts[1] == null) {
//	        throw new IllegalArgumentException("Unknown chart type " + types[2]);
//	      } else {
//	        XYMultipleSeriesDataset newDataset1 = new XYMultipleSeriesDataset();
//	        newDataset1.addSeries(dataset.getSeriesAt(2));
//	        XYMultipleSeriesRenderer newRenderer1 = new XYMultipleSeriesRenderer();
//	        // TODO: copy other parameters here
//	        newRenderer1.setBarSpacing(renderer.getBarSpacing());
//	        newRenderer1.setPointSize(renderer.getPointSize());
//	        scale = dataset.getSeriesAt(2).getScaleNumber();
//	        if (renderer.isMinXSet(scale)) {
//	          newRenderer1.setXAxisMin(renderer.getXAxisMin(scale));
//	        }
//	        if (renderer.isMaxXSet(scale)) {
//	          newRenderer1.setXAxisMax(renderer.getXAxisMax(scale));
//	        }
//	        if (renderer.isMinYSet(scale)) {
//	          newRenderer1.setYAxisMin(renderer.getYAxisMin(scale));
//	        }
//	        if (renderer.isMaxYSet(scale)) {
//	          newRenderer1.setYAxisMax(renderer.getYAxisMax(scale));
//	        }
//	        newRenderer1.addSeriesRenderer(renderer.getSeriesRendererAt(2));
//	        mCharts[1].setDatasetRenderer(newDataset1, newRenderer1);
//	      }
//	  }
